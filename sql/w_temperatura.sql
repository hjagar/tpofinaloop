...
CREATE TABLE `w_temperaturasensortemperaturaaviso`  (
  ...
  PRIMARY KEY (`idtemperaturaaviso`, `idtemperaturaalarma`) USING BTREE,
  INDEX `fk_w_temperaturasensortemperaturaaviso_w_temperaturaalarmas_1`(`idtemperaturaalarma`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
