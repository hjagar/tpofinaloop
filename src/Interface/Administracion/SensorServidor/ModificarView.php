...
{
    protected $title = 'Modificar Sensor Servidor';
    ...
    public function updateInputs($idtemperaturaalarma): bool
    {
        ...
        if ($alarma) {
            ...
            $this->showError(Constantes::formatMessage(Constantes::NOT_FOUND_ERROR_MESSAGE, "Sensor Servidor {$idtemperaturaalarma}"));
            $returnValue = false;
        }
    ...
    public function save(): void 
    {
        ...
        if (is_object($returnValue) && $returnValue) {
            $this->showSuccess(Constantes::formatMessage(Constantes::UPDATE_MESSAGE, 'Sensor Servidor'));
        } else {
